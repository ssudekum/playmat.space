...
const Deck : React.FC<DeckProps> = ({ addPlaymatCards }) => {
    ...
    return <div className="list-container">
        ...
        <button className="button" onClick={() => setIsModalVisible(true)}>Import List</button>
        <button className="button" disabled={cards.getTotalCount() === 0 ? true : false} onClick={() => addPlaymatCards(cards)}>Add to Playmat</button>
        <CardTable cards={cards}></CardTable>
        <ImportModal visible={isModalVisible} setVisible={setIsModalVisible} onImport={onImport}></ImportModal>
    </div>
}
